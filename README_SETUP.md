...
- Em deploy estático sem `import.meta.env`, injete `window.__ENV__` antes do bootstrap com as mesmas chaves (`VITE_SUPABASE_URL`, `VITE_SUPABASE_ANON_KEY`, `VITE_ENABLE_VERBOSE_LOGS`).
